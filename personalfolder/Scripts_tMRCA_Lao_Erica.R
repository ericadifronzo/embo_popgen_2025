...
folder.fastSimcoal2 <- "/home/difronzo/embo_popgen_2025/Oscar_Lao/Afternoon";
...
hist(data$Time_.gen., breaks = 50, col = "cornflowerblue", main = "TMRCA Distribution", xlab = "Generations")
