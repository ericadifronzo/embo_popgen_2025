---
  title: Genetic Drift    # Matthias lesson 24.06.25
  output: html_document   #Genetic drift exercise
---
...
# at the end, if i count what % of freq get fixed and what % get lost, i will get 50 50
# if i set the fA at 0.3, then i'll get that 30% gets fixed, and the 70% gets lost
